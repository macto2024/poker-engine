import unittest
from handevaluator import HandEvaluator, HandRankEncoder, HandRankDecoder
...
class TestHandEvaluation(unittest.TestCase):
    ...
    def test_straight(self):
        ...
        expected_best_hand = ['As', 'Kh', 'Qd', 'Js', '10c']
    ...
    def test_ace_low_straight(self):
        ...
        self.assertEqual(hand_type, "STRAIGHT")
        expected_best_hand = ['As', '5s', '4c', '3h', '2d']
        self.assertEqual([str(card) for card in best_hand], expected_best_hand)
...
# hand_type, ranks = HandRankDecoder.decode_hand(encoded_hand_rank)

# print(f"Hand Type: {hand_type}")  # Output: TWOPAIR
# print(f"Ranks: {ranks}")  # Output: [13, 13, 10, 10, 5]